...
| 'permission:get-status'
  ...
  | 'local-ai:ollama-start'
  | 'local-ai:ollama-stop'
...
| 'piper:download-models'
  ...
  | 'scheduler:clear-history'
  | 'scheduler:get-profiles'
  | 'scheduler:update-profile'
  | 'scheduler:reset-profiles'
...
| 'automation:list'
  ...
  | 'authorization:set-level'
  | 'authorization:list-trust'
  | 'authorization:add-trust'
  | 'authorization:remove-trust'
  | 'authorization:list-logs'
  | 'authorization:clear-logs'
  | 'command-policy:list-trusted'
  | 'command-policy:add-trusted'
  | 'command-policy:remove-trusted'
  | 'command-policy:list-builtins'
  | 'command-policy:set-builtin-level'
  | 'software-library:list'
  | 'software-library:add'
  | 'software-library:scan'
  | 'software-library:remove'
  | 'software-library:set-status'
  | 'software-library:link-skillpack'
  | 'software-library:templates'
  | 'software-library:import-template'
  | 'software-library:guides'
  | 'software-library:dictionary'
  | 'software-library:match-intent'
  | 'ext:list'
  | 'ext:catalog'
  | 'ext:install'
  | 'ext:import-local'
  ...
  | 'ext:check-compat'
  // ===== 悬浮球语音交互面板（语音中枢） =====
  | 'floating-ball:open-voice-panel'
  | 'floating-ball:close-voice-panel'
  | 'floating-ball:voice-toggle'
  | 'floating-ball:voice-start'
  | 'floating-ball:voice-feed'
  | 'floating-ball:voice-stop'
  | 'floating-ball:voice-ask'
  | 'floating-ball:voice-tts'
  | 'floating-ball:voice-cancel'
  | 'floating-ball:get-voice-settings'
  | 'floating-ball:set-voice-settings'
  | 'floating-ball:get-presence'
  | 'floating-ball:voice-panel-state'
  | 'floating-ball:auto-start'
  | 'floating-ball:set-presence'
...
const api = {
  ...
  // FIX: 本地导入扩展时获取拖入/选择的文件真实路径（Electron 32 移除 File.path）
